  ...
  try {
    ...
    const updatedConfig = {
      ...
      blogCTA: {
        ...
        title: settings.ctaTitle || 'Join Our Waitlist - Be One of the First CalendHub Creators',
        description: settings.ctaDescription || "Get exclusive early access to CalendHub's revolutionary AI creation platform. Join the select group of pioneering creators shaping the future of AI-powered content.",
