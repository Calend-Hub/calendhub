...
<div className="callout callout-warning">
  ⚠️ <strong>DST Danger Zones:</strong> The weeks immediately after DST transitions see 3x higher rates of scheduling confusion and missed meetings. Be extra careful with meeting confirmations during these periods and verify times explicitly rather than assuming calendar translations are correct.
</div>
